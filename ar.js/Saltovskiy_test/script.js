let entity = null, markerVisible = false, cursor, raycaster, text, textInterval = new Array(), iOs = false,
...
window.onload = () => {
  ...
  if (iOs) {
    let img = document.querySelector("#micro");
    img.style.display = "block";
    img.addEventListener("touchstart", () => {
      img.setAttribute("src", "./micro_on.png");
      audio01.play();
