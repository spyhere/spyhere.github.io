document.addEventListener('DOMContentLoaded', () => {
    ...
    var cards = [
        ...
        {name: "Hellbat",
        src: "images/Hellbat.jpg"},
        {name: "Hellion",
        src: "images/Hellion.jpg"},
        {name: "Liberator",
        src: "images/Liberator.jpg"},
        {name: "Marauder",
        src: "images/Marauder.jpg"},
        {name: "Marine",
        src: "images/Marine.jpg"},
        {name: "Raven",
        src: "images/Raven.jpg"},
        {name: "SiegeTank",
        src: "images/SiegeTank.jpg"}
    ]
    cards.push(...cards);
    ...
    function flip() {
        ...
        setTimeout(() => {images[Number(cardId)+1].setAttribute('style', 'z-index: 10; position: absolute; right: 0; transform: rotateY(0deg)');
                          images[Number(cardId)+1].removeEventListener('click', flip)  }, 280);
    ...
    function checkMatch() {
        ...
        if (CardsOut.length == cards.length/2) {
            ...
            setTimeout(() => {for (let i=1; i < cards.length*2; i+=2) {
    ...
    function restart() {
        ...
        moves = 0;
        document.querySelector('#victory').currentTime = 0;
        document.querySelector('#victory').pause();
        grid();
    }
    grid();
